# Ollama-js-tutorial
This repository contains examples to learn how to use Ollama with JavaScript.
It demonstrates how to generate text, stream responses, and interact with locally running LLMs.
...
```bash
# Downlaod the repo.
git clone https://codeberg.org/felixdrp/ollama-js-tutorial
